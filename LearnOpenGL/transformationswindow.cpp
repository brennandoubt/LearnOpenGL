...
//#include "Shader.h"
//
//// GLM: mathematics library to use for transformations
//#include <glm/glm.hpp>
...
//	Shader ourShader("transformation.vs", "texture.fs");
//
//
//
...
//	// 5.1. transformations
//
//	// example 1: translating vector (1, 0, 0) by (1, 1, 0) to get (1+1, 0+1, 0+0) => (2, 1, 0)
//	//glm::vec4 vec(1.0f, 0.0f, 0.0f, 1.0f);	// define a new vector "vec"
//	//glm::mat4 trans = glm::mat4(1.0f);	// define a new identity matrix with 1.0 diagonals
//	//// create a transformation matrix using identity matrix and a translation vector
//	//trans = glm::translate(trans, glm::vec3(1.0f, 1.0f, 0.0f));
//	//// multiply vector by transformation matrix to finally translate vector
//	//vec = trans * vec;
//	//std::cout << vec.x << vec.y << vec.z << std::endl;
//
//	// example 2: scale and rotate container object
//	//glm::mat4 trans = glm::mat4(1.0f);
//	//trans = glm::rotate(trans, glm::radians(90.0f), glm::vec3(0.0, 0.0, 1.0));	// rotate container 90 degrees around Z-axis
...
//		glm::mat4 transform = glm::mat4(1.0f);	// initialize as identity matrix
